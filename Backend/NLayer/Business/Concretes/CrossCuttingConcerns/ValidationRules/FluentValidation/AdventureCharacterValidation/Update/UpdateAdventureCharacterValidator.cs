...
namespace NLayer.Business.Concretes.CrossCuttingConcerns.ValidationRules.FluentValidation.AdventureCharacterValidation.Update;

public class UpdateAdventureCharacterValidator : BaseUpdateValidator<UpdateAdventureCharacterRequest>
{
    public UpdateAdventureCharacterValidator()
    {
