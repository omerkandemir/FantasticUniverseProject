...
namespace NLayer.Business.Concretes.CrossCuttingConcerns.ValidationRules.FluentValidation.AdventureValidation.Update;

public class UpdateAdventureValidator : BaseUpdateValidator<UpdateAdventureRequest>
{
