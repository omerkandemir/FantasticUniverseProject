...
namespace NLayer.Business.Concretes.CrossCuttingConcerns.ValidationRules.FluentValidation.PlanetValidation.Update;

public class UpdatePlanetValidator : BaseUpdateValidator<UpdatePlanetRequest>
{
