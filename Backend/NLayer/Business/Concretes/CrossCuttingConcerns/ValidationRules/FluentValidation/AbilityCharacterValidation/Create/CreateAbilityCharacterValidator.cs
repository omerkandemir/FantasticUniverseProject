...
namespace NLayer.Business.Concretes.CrossCuttingConcerns.ValidationRules.FluentValidation.AbilityCharacterValidation.Create;

public class CreateAbilityCharacterValidator : BaseCreateValidator<CreateAbilityCharacterRequest>
{
    public CreateAbilityCharacterValidator()
    {
