...
namespace NLayer.Business.Concretes.CrossCuttingConcerns.ValidationRules.FluentValidation.UnionValidation.Update;

public class UpdateUnionValidator : BaseUpdateValidator<UpdateUnionRequest>
{
    public UpdateUnionValidator()
    {
