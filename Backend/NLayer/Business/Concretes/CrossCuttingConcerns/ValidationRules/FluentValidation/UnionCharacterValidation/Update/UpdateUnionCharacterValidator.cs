...
namespace NLayer.Business.Concretes.CrossCuttingConcerns.ValidationRules.FluentValidation.UnionCharacterValidation.Update;

public class UpdateUnionCharacterValidator : BaseUpdateValidator<UpdateUnionCharacterRequest>
{
    public UpdateUnionCharacterValidator()
    {
