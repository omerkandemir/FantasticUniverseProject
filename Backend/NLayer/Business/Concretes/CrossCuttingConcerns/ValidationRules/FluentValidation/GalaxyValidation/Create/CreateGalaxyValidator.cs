...
namespace NLayer.Business.Concretes.CrossCuttingConcerns.ValidationRules.FluentValidation.GalaxyValidation.Create;

public class CreateGalaxyValidator : BaseCreateValidator<CreateGalaxyRequest>
{
